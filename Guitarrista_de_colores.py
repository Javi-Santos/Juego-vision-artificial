# -*- coding: utf-8 -*-
"""
Created on Sat Oct  2 10:39:35 2021

@author: javier.santos
"""
#--------------------------------------------------------------------------
#------- GUITARRISTA DE COLORES ----------------------------------------------
#------- Conceptos básicos de PDI------------------------------------------
#------- Por: Javier Eduardo Santos Ramos  javier.santos@udea.edu.co -----
...
#------- Inicio del juego-----------------------------------------------------
inicio = cv2.imread('./image/INICIO.png') #Carga la imagen de inicio, cuyas dimensiones son 640x480 
cv2.imshow('GUITARRISTA DE COLORES', inicio) #Vizualiza la ventana con la imagen de inicio
...
while True:
    ...
    if x_verde !=0:#Si se logra identificar dicho objeto la componente de X será diferente de 0, entonces continuara lo siguiente
        ...
        cv2.putText(fondo, 'FAVOR MOSTRAR OBJETO VERDE ', (80, 200),cv2.FONT_HERSHEY_DUPLEX,1,(255,255,255),2)#Escribe sobre la imagen de fondo
    ...
    if i>=420:#Si la nota baja a mas de 350 en Y no se podrá haer punto a favor, igual si la nota llega a 420 en Y se confirma el punto en contra
